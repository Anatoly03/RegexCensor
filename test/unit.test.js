...
test("Filter (Trigger)", async function (t) {
    ...
    await t.test(
        "should be not triggered by `Hello, World!`",
        async function (t) {
...
test("Filter (Find)", async function (t) {
    ...
    await t.test(
        "should find `foo` and `bar`, but not combinations",
        async function (t) {
            assert.deepEqual(
                filter.find("foo bar foobarbug bugfoo bugbar").sort(),
                ["foo", "bar"].sort()
            );
        }
    );
...
test("Filter (Replace)", async function (t) {
    await t.test(
        "should replace `hello foo` with `hello ***`",
        async function (t) {
    ...
    await t.test(
        "should replace `fix my bug` with `fix my ***`",
        async function (t) {
